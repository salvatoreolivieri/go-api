...
type User struct {
	...
	Password  password `json:"-"` // Password is not stored in the database
...
func (s *UserStore) createUserInvitation(ctx context.Context, tx *sql.Tx, token string, expiration time.Duration, userID int64) error {
